...
![Skor GTmetrix Kodesiana.com](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/42081974795_f1df5d9997_o_d.jpg)

Skor GTmetrix Kodesiana.com

Gambar di atas merupakan contoh laporan skor metrik **PageSpeed** dan **YSlow** website Kodesiana.com. Selain nilai metrik **PageSpeed** dan **YSlow**, faktor lain seperti *front-end* dan *back-end* juga perlu diperhatikan. Anda dapat membaca artikel pada [blog GTmetrix](https://gtmetrix.com/blog/pagespeed-and-yslow-are-half-the-battle/) berikut untuk informasi lebih lanjut.
...
Buka cPanel kemudian buat subdomain baru. Pada contoh ini penulis membuat subdomain `https://cdn.kodesiana.com` dengan *target folder* */public_html*. Pastikan *target folder* adalah folder yang sama dengan website/blog Anda. Folder ini dapat berbeda sesuai server yang Anda gunakan.

![Membuat Subdomain untuk CDN](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/42081975495_b7048e52dc_o_d.png)

Membuat Subdomain untuk CDN

![Entri Subdomain Baru untuk CDN](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/42081975995_7123438da0_o_d.png)

Entri Subdomain Baru untuk CDN

Setelah Anda membuat subdomain baru, selanjutnya Anda buka **DNS Zone Editor** kemudian hapus semua entri _A_ dan *TXT* yang ada pada entri baru Anda. Kemudian buat entri CNAME yang mengarah pada domain utama Anda. Pada contoh ini entri *cdn.kodesiana\_\_.com* hanya memiliki *CNAME* yang mengarah ke *kodesiana.com*.

![Setting DNS Zone untuk Subdomain CDN](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/42265141514_d81f4ce9fb_o_d.png)
...
![Pengaturan CDN](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/42265140234_a571898563_o_d.jpg)

#### Konfigurasi Minification

Buka **Performance > Minify,** kemudian klik tombol **Help** pada bagian atas W3 Total Cache.

![Tombol Help untuk Menambahkan Entri JS/CSS](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/41173606200_9e424281cd_o_d.jpg)
...
![Pilihan Entri JS](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/42081975325_fc49232fe4_o_d.jpg)
...
![Pilihan Entri CSS](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/42265140414_fd908061ee_o_d.jpg)
...
![Mengatur Urutan Load JS/CSS](https://kodesianastorage.blob.core.windows.net/kodesiana-public-assets/posts/2018/10/42081980655_6dbae2ef11_o_d.jpg)

Anda dapat melakukan *drag-n-drop* pada item JS/CSS untuk mengatur urutan _loading-nya._ Secara umum, Anda harus mengikuti aturan berikut:
...
3. Wikipedia. 2018. Content Delivery Network ([_https://en.wikipedia.org/wiki/Content_delivery_network_](https://en.wikipedia.org/wiki/Content_delivery_network)). Diakses 18 Juni 2018.
